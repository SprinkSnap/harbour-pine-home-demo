    ...
    open && mounted
      ? createPortal(
          <div className="fixed inset-0 z-[85]" role="presentation">
            ...
            />
            <section
              className="absolute inset-x-0 bottom-0 flex h-[min(85dvh,640px)] w-full max-w-md flex-col rounded-t-[var(--radius-xl)] bg-porcelain pb-[env(safe-area-inset-bottom)] shadow-[var(--shadow-lift)] sm:inset-x-auto sm:bottom-4 sm:right-4 sm:rounded-[var(--radius-xl)]"
              role="dialog"
              aria-modal="true"
